...
class EEGTransformerReconstructor(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.reconstructor_proj_time = nn.Linear(reconstructor_embed_dim, patch_size, bias=True)
        self.reconstructor_proj_fft1 = nn.Linear(reconstructor_embed_dim, patch_size, bias=True)
        self.reconstructor_proj_fft2 = nn.Linear(reconstructor_embed_dim, patch_size, bias=True)
        # ------
    ...
    def forward(self, x, chan_ids=None, mask_x=None, mask_y=None):
        ...
        if mask_y is not None:
            ...
            fft1 = self.reconstructor_proj_fft1(x)
            fft2 = self.reconstructor_proj_fft2(x)    
            x = self.reconstructor_proj_time(x)
