...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=(64, 2500), patch_size=50, patch_stride=None, embed_dim=768):
        super().__init__()
...
class Downstream_model(nn.Module):
    def __init__(self, load_path="/ssd1/qinzehao/new/v17/pretrain/checkpoint-40.pth"):
        super().__init__()    
        self.chans_num = 12
        print('用的是新的')
        ...
        target_encoder = EEGTransformer_old(
            img_size=[12, 2500], # 这里在跑单导联/6导联实验的时候需要修改
            patch_size=50,
            embed_num=1,
            embed_dim=256,
            depth=8,
        ...
        # self.linear1   =  nn.Linear(512, 24)
        # self.linear2   =  nn.Linear(720, 2)
