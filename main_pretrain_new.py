...
from new_model_v2 import LitEEGPT
import util.misc as misc
from engine_pretrain_new import train_one_epoch
from util.dataset_copy import build_dataset, get_dataloader
...
def main(config):
    ...
    data_loader_train = get_dataloader(dataset_train_mimic,
